...
public class CustomerForm extends AbstractForm<Customer> {
    ...
    private PasswordField passwordConfirmationField = new PasswordField("Password confirmation");
    ...
    private AbstractForm.SavedHandler<Customer> formSaveHandler =
            new AbstractForm.SavedHandler<Customer>() {
    ...
    private AbstractForm.ResetHandler<Customer> formResetHandler =
            new AbstractForm.ResetHandler<Customer>() {
    ...
    public CustomerForm() {
        ...
        formLayout = new FormLayout(userName, firstName, lastName, birthDate, roles);
    }
    ...
    protected Component createContent() {
        ...
        VerticalLayout layout = new MVerticalLayout(formLayout).add(toolbar, Alignment.BOTTOM_RIGHT)
                                                               .expand(formLayout);
    ...
    private CustomerSavedEvent buildCustomerSaveEvent(Customer customer) {
        ...
        customerSavedEvent.setPasswordConfirmation(passwordConfirmationField.getValue());
     ...
     * @param toolbar
     */
    private void hideToolbarFromNonAdminUsers(FormLayout formLayout, Layout toolbar) {
