...
public class CustomerTable extends CustomComponent {
    ...
    private MValueChangeListener<Customer> tableValueChangeListener =
            new MValueChangeListener<Customer>() {
    ...
    private Button.ClickListener removeClickListener = new Button.ClickListener() {
        ...
        @Override
        public void buttonClick(ClickEvent event) {
            customerRemovedEvent.fire(new CustomerRemovedEvent(customerTable.getValue()));
        }
    };
    ...
    private Button.ClickListener editClickListener = new Button.ClickListener() {
        ...
        @Override
        public void buttonClick(ClickEvent event) {
            customerSelectedEvent.fire(new CustomerSelectedEvent(customerTable.getValue()));
        }
    };
    ...
    public CustomerTable() {
        ...
        removeCustomer = new ConfirmButton(FontAwesome.TRASH_O,
                "Are you sure you want to remove this customer?", removeClickListener);
        ...
        HorizontalLayout buttonLayout =
                new MHorizontalLayout(addCustomer, removeCustomer, editCustomer);

        layout.addComponents(buttonLayout, customerTable);
        layout.expand(customerTable);

        buttonLayout.setVisible(SecurityUtils.getSubject()
                                             .hasRole("admin"));
    ...
    public void setCustomers(Collection<Customer> customers) {
        ...
        customerTable.setVisibleColumns("id", "firstName", "lastName", "birthDate");
    }
