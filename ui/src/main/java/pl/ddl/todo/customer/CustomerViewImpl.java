...
public class CustomerViewImpl extends AbstractView<CustomerViewPresenter> implements CustomerView {
    ...
    public void showPasswordDontMatchNotification() {
        Notification.show("Password not given or password don't match", Type.TRAY_NOTIFICATION);
    }
}
