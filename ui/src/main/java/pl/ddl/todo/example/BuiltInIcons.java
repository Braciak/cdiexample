...
public class BuiltInIcons extends AbstractView<ExampleViewPresenter> implements ExampleView {
    ...
    public BuiltInIcons() {
        ...
        setCompositionRoot(new MVerticalLayout(
                new RichText().withMarkDown("# All FontAwesome(ness) available in 7.2"), label));
    }
